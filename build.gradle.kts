...
loom {
    accessWidenerPath = file("src/main/resources/florence-client.accesswidener")
}
...
tasks {
    ...
    jar {
        ...
        manifest {
            attributes["Main-Class"] = "florencedevelopment.florenceclient.Main"
        }
    }
