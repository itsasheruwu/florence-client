...
import florencedevelopment.florenceclient.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "florencedevelopment.florenceclient.mixin";
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            ...
            FlorenceClient.LOG.error("Error loading the mixin plugin", e);
        }
