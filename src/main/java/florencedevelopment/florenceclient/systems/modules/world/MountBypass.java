...
public class MountBypass extends Module {
    ...
    public void onSendPacket(PacketEvent.Send event) {
        ...
        if (event.packet instanceof IPlayerInteractEntityC2SPacket packet) {
            if (packet.florence$getType() == PlayerInteractEntityC2SPacket.InteractType.INTERACT_AT && packet.florence$getEntity() instanceof AbstractDonkeyEntity) event.cancel();
        }
    }
}
