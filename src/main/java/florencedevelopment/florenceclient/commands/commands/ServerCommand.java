    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof CommandTreeS2CPacket packet) {
            ...
            packet.getCommandTree(
                CommandRegistryAccess.of(handler.florence$getCombinedDynamicRegistries(), handler.florence$getEnabledFeatures()),
                ClientPlayNetworkHandlerAccessor.florence$getCommandNodeFactory()
