...
import florencedevelopment.florenceclient.mixin.EntityVelocityUpdateS2CPacketAccessor;
...
public class Velocity extends Module {
    ...
    private void onPacketReceive(PacketEvent.Receive event) {
        if (knockback.get() && event.packet instanceof EntityVelocityUpdateS2CPacket packet
            ...
            ((EntityVelocityUpdateS2CPacketAccessor) packet).florence$setVelocity(
