...
public class FlorenceTextHud {
    public static final HudElementInfo<TextHud> INFO = new HudElementInfo<>(Hud.GROUP, "text", "Displays arbitrary text with Starscript.", FlorenceTextHud::create);
    ...
    static {
        ...
        WATERMARK = addPreset("Watermark", "[bold][accent]F[bold] lorence Client #1{meteor.version}");
