...
import florencedevelopment.florenceclient.utils.notebot.NotebotUtils;
import florencedevelopment.florenceclient.utils.notebot.decoder.SongDecoder;
import florencedevelopment.florenceclient.utils.notebot.decoder.SongDecoders;
import florencedevelopment.florenceclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
import florencedevelopment.florenceclient.utils.notebot.song.Note;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = FlorenceClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    FlorenceClient.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
