...
import florencedevelopment.florenceclient.mixin.ShulkerBoxScreenHandlerAccessor;
...
import florencedevelopment.florenceclient.utils.misc.HorizontalDirection;
import florencedevelopment.florenceclient.utils.misc.MBlockPos;
import florencedevelopment.florenceclient.utils.player.*;
...
import florencedevelopment.florenceclient.utils.world.Dir;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.world.getEntities()) {
                    ...
                    ((IVec3d) vec1).florence$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getStandingEyeHeight(), b.mc.player.getZ());
                    ((IVec3d) vec2).florence$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock ignored -> {
                        if (b.mc.currentScreen instanceof ShulkerBoxScreen screen) {
                            ...
                            Inventory inv = ((ShulkerBoxScreenHandlerAccessor) screen.getScreenHandler()).florence$getInventory();
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see florencedevelopment.florenceclient.mixin.MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
