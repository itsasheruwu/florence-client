...
package florencedevelopment.florenceclient;
...
import florencedevelopment.florenceclient.utils.ReflectInit;
import florencedevelopment.florenceclient.utils.Utils;
import florencedevelopment.florenceclient.utils.misc.Version;
...
public class FlorenceClient implements ClientModInitializer {
    public static final String MOD_ID = "florence-client";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static FlorenceClient INSTANCE;
    public static FlorenceAddon ADDON;
    ...
    static {
        ...
        BUILD_NUMBER = MOD_META.getCustomValue(FlorenceClient.MOD_ID + ":build_number").getAsString();
    }
    ...
    public void onInitializeClient() {
        ...
        // Initialise addons
        AddonManager.ADDONS.forEach(FlorenceAddon::onInitialize);
    ...
    public static Identifier identifier(String path) {
        return Identifier.of(FlorenceClient.MOD_ID, path);
    }
}
