...
import florencedevelopment.florenceclient.renderer.MeshBuilder;
...
import florencedevelopment.florenceclient.utils.render.MeshBuilderVertexConsumerProvider;
import florencedevelopment.florenceclient.utils.render.RenderUtils;
import florencedevelopment.florenceclient.utils.render.SimpleBlockRenderer;
...
public class StorageESP extends Module {
    ...
    public StorageESP() {
        ...
        mesh = new MeshBuilder(FlorenceRenderPipelines.WORLD_COLORED);
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (mode.get() == Mode.Shader && count > 0) {
            MeshRenderer.begin()
                ...
                .pipeline(FlorenceRenderPipelines.WORLD_COLORED)
