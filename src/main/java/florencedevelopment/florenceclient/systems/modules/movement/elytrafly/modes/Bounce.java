...
package florencedevelopment.florenceclient.systems.modules.movement.elytrafly.modes;
...
import florencedevelopment.florenceclient.systems.modules.movement.elytrafly.ElytraFlightMode;
    ...
    private static boolean startGliding(ClientPlayerEntity player) {
        for (EquipmentSlot equipmentSlot : EquipmentSlot.VALUES) {
            if (LivingEntity.canGlideWith(player.getEquippedStack(equipmentSlot), equipmentSlot)) {
                FlorenceClient.mc.executeSync(player::startGliding);
                return true;
            }
        }
