...
public class PacketUtilsUtil {
    ...
    public static void init() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            writer.write("/*\n");
            writer.write(" * This file is part of the Florence Client distribution (https://github.com/FlorenceDevelopment/florence-client/).\n");
            writer.write(" * Copyright (c) Florence Development.\n");
            writer.write(" */\n\n");

            writer.write("package florencedevelopment.florenceclient.utils.network;\n\n");
