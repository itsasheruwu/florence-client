...
public class Capes {
    private static final String CAPE_OWNERS_URL = "https://FlorenceClient.com/api/capeowners";
    private static final String CAPES_URL = "https://FlorenceClient.com/api/capes";
    ...
    @PreInit(dependencies = FlorenceExecutor.class)
    public static void init() {
        ...
        FlorenceExecutor.execute(() -> {
            ...
            Stream<String> lines = Http.get(CAPE_OWNERS_URL)
                .exceptionHandler(e -> FlorenceClient.LOG.error("Could not load capes: {}",  e.getMessage()))
                .sendLines();
            if (lines != null) {
                lines.forEach(s -> {
        ...
        FlorenceClient.EVENT_BUS.subscribe(Capes.class);
    }
    ...
    private static class Cape {
        ...
        public Cape(String name) {
            this.identifier = FlorenceClient.identifier("capes/" + COUNT++);
            this.name = name;
        }
        ...
        public void download() {
            ...
            FlorenceExecutor.execute(() -> {
                try {
                    ...
                    FlorenceClient.LOG.error("Failed to download cape '{}'", name, e);
                }
            });
        }
