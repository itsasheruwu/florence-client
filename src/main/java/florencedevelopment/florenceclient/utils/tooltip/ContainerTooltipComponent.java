...
public class ContainerTooltipComponent implements TooltipComponent, FlorenceTooltipData {
    private static final Identifier TEXTURE_CONTAINER_BACKGROUND = FlorenceClient.identifier("textures/container.png");
