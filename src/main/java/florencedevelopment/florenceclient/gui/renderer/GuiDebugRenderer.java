...
public class GuiDebugRenderer {
    ...
    private final MeshBuilder mesh = new MeshBuilder(FlorenceRenderPipelines.WORLD_COLORED_LINES);
    ...
    public void render(WWidget widget) {
        ...
        MeshRenderer.begin()
            ...
            .pipeline(FlorenceRenderPipelines.WORLD_COLORED_LINES)
            .mesh(mesh)
            .end();
    }
    ...
    public void mouseReleased(WWidget widget, Click click, int i) {
        ...
        FlorenceClient.LOG.info("{} {}", widget.getClass(), i);
