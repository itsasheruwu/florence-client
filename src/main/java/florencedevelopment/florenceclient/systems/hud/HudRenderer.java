...
import florencedevelopment.florenceclient.renderer.*;
import florencedevelopment.florenceclient.renderer.text.CustomTextRenderer;
import florencedevelopment.florenceclient.renderer.text.Font;
import florencedevelopment.florenceclient.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(FlorenceRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(FlorenceRenderPipelines.UI_TEXT);
