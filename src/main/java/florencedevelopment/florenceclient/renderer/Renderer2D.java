...
import florencedevelopment.florenceclient.gui.renderer.packer.TextureRegion;
...
public class Renderer2D {
    ...
    public Renderer2D(boolean textured) {
        ...
        triangles = new MeshBuilder(textured ? FlorenceRenderPipelines.UI_TEXTURED : FlorenceRenderPipelines.UI_COLORED);
        lines = new MeshBuilder(FlorenceRenderPipelines.UI_COLORED_LINES);
    }
    ...
    public void render(String samplerName, GpuTextureView samplerView, GpuSampler sampler) {
        ...
        MeshRenderer.begin()
            ...
            .pipeline(FlorenceRenderPipelines.UI_COLORED_LINES)
            .mesh(lines)
            .end();

        MeshRenderer.begin()
            .attachments(MinecraftClient.getInstance().getFramebuffer())
            .pipeline(textured ? FlorenceRenderPipelines.UI_TEXTURED : FlorenceRenderPipelines.UI_COLORED)
            .mesh(triangles)
