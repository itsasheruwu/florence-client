...
import florencedevelopment.florenceclient.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapTexture texture = textureManager.florence$invokeGetMapTexture(map.get(DataComponentTypes.MAP_ID), state);
        ...
        try {
            ...
            FlorenceClient.LOG.error(e.toString());
        }
    }
