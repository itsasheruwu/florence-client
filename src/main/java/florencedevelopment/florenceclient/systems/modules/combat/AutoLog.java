...
import florencedevelopment.florenceclient.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        FlorenceClient.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        FlorenceClient.EVENT_BUS.unsubscribe(staticListener);
    }
}
