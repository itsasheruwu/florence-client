...
import florencedevelopment.florenceclient.events.render.TooltipDataEvent;
import florencedevelopment.florenceclient.gui.screens.ContainerInventoryScreen;
import florencedevelopment.florenceclient.mixin.EntityAccessor;
import florencedevelopment.florenceclient.mixin.EntityBucketItemAccessor;
...
import florencedevelopment.florenceclient.utils.misc.ByteCountDataOutput;
...
import florencedevelopment.florenceclient.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    ...
    private void getTooltipData(TooltipDataEvent event) {
        ...
        // Fish peek
            ...
            EntityType<?> type = ((EntityBucketItemAccessor) bucketItem).florence$getEntityType();
            ...
            if (entity != null) {
                ...
                ((EntityAccessor) entity).florence$setInWater(true);
