...
import florencedevelopment.florenceclient.mixin.DirectionAccessor;
...
public class Surround extends Module {
    ...
    private boolean place(BlockPos placePos, FindItemResult block) {
        ...
        for (BlockBreakingInfo value : ((WorldRendererAccessor) mc.worldRenderer).florence$getBlockBreakingInfos().values()) {
