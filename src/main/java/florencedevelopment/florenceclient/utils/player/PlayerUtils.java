...
import florencedevelopment.florenceclient.systems.modules.movement.NoFall;
...
import florencedevelopment.florenceclient.utils.misc.text.TextUtils;
...
import static florencedevelopment.florenceclient.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        ((IVec3d) horizontalVelocity).florence$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).florence$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(), mc.player.getZ());
        ((IVec3d) vec2).florence$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3d) vec2).florence$set(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
