...
package florencedevelopment.florenceclient.systems.modules.misc.swarm;
...
public class Swarm extends Module {
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        guide.action = () -> Util.getOperatingSystem().open("https://github.com/FlorenceDevelopment/florence-client/wiki/Swarm-Guide");
