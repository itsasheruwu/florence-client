...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = FlorenceClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = FlorenceClient.identifier("textures/container-transparent.png");
