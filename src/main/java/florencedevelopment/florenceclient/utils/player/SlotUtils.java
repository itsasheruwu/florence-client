...
import florencedevelopment.florenceclient.mixin.CreativeInventoryScreenAccessor;
import florencedevelopment.florenceclient.mixin.ItemGroupsAccessor;
import florencedevelopment.florenceclient.mixin.MountScreenHandlerAccessor;
...
public class SlotUtils {
    ...
    private static int creativeInventory(int i) {
        if (CreativeInventoryScreenAccessor.florence$getSelectedTab() != Registries.ITEM_GROUP.get(ItemGroupsAccessor.florence$getInventory()))
            return -1;
    ...
    private static int horse(ScreenHandler handler, int i) {
        LivingEntity entity = ((MountScreenHandlerAccessor) handler).florence$getMount();
