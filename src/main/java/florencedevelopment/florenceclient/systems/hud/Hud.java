...
package florencedevelopment.florenceclient.systems.hud;
...
import florencedevelopment.florenceclient.systems.hud.elements.*;
...
public class Hud extends System<Hud> implements Iterable<HudElement> {
    ...
    private void resetToDefaultElementsImpl() {
        ...
        // Top Left
        add(FlorenceTextHud.WATERMARK, 4, 4, XAnchor.Left, YAnchor.Top);
        add(FlorenceTextHud.FPS, 4, 4 + h, XAnchor.Left, YAnchor.Top);
        add(FlorenceTextHud.TPS, 4, 4 + h * 2, XAnchor.Left, YAnchor.Top);
        add(FlorenceTextHud.PING, 4, 4 + h * 3, XAnchor.Left, YAnchor.Top);
        add(FlorenceTextHud.SPEED, 4, 4 + h * 4, XAnchor.Left, YAnchor.Top);

        // Top Right
        add(ActiveModulesHud.INFO, -4, 4, XAnchor.Right, YAnchor.Top);

        // Bottom Right
        add(FlorenceTextHud.POSITION, -4, -4, XAnchor.Right, YAnchor.Bottom);
        add(FlorenceTextHud.OPPOSITE_POSITION, -4, -4 - h, XAnchor.Right, YAnchor.Bottom);
        add(FlorenceTextHud.ROTATION, -4, -4 - h * 2, XAnchor.Right, YAnchor.Bottom);
    }
