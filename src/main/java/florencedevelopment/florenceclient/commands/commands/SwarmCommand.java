...
import florencedevelopment.florenceclient.systems.modules.misc.swarm.SwarmConnection;
import florencedevelopment.florenceclient.systems.modules.misc.swarm.SwarmWorker;
import florencedevelopment.florenceclient.systems.modules.world.InfinityMiner;
                        ...
                        .then(argument("port", IntegerArgumentType.integer(0, 65535))
                                .executes(context -> {
                                    ...
                                    info(Text.literal("Click here to confirm").setStyle(Style.EMPTY
                                        ...
                                        .withClickEvent(new FlorenceClickEvent(".swarm join confirm"))
                                    ));
